...
var Neo = function(_arguments) {
    ...
    var node = function(_origin) {
         ...
         * @param save {*=} If we'regex saving history.
         * @returns {Neo.node}
         */
        this.bind = function(_events, callback, save) {
        ...
        this.css = function(selector, rule) {
            ...
            if(!global.isDefined(rule)) {
                ...
                if(value.length > 0 && global.format().startsWith(value, "rgb(")) {
    ...
    var arithmetic = {
         ...
         * @returns {boolean}
         */
        between: function(number, minimum, maximum) {
